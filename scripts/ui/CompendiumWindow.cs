...
namespace Kuros.UI
{
    ...
    public partial class CompendiumWindow : Control
    {
        ...
        public override void _UnhandledInput(InputEvent @event)
        {
            ...
            if (isEscKey)
            {
                // ESC键始终直接关闭图鉴窗口，返回上一层级
                GD.Print("CompendiumWindow._UnhandledInput: ESC键关闭图鉴窗口");
                HideWindow();
        ...
        public override void _GuiInput(InputEvent @event)
        {
            ...
            {
                // ESC键始终直接关闭图鉴窗口，返回上一层级
                GD.Print("CompendiumWindow._GuiInput: ESC键关闭图鉴窗口");
                HideWindow();
                AcceptEvent();
            }
        }
        ...
        public override void _Input(InputEvent @event)
        {
            ...
            {
                // ESC键始终直接关闭图鉴窗口，返回上一层级
                GD.Print("CompendiumWindow._Input: ESC键关闭图鉴窗口");
                HideWindow();
                GetViewport().SetInputAsHandled();
            }
        }
